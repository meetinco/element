  ...
  export default {
    ...
    computed: {
      ...
      rows() {
        ...
        const dateCountOfLastMonth = getDayCountOfMonth(date.getFullYear(), (date.getMonth() === 0 ? 11 : date.getMonth() -
          1));
    ...
    methods: {
      ...
      getCellClasses(cell) {
        ...
        if (selectionMode === 'day' && (cell.type === 'normal' || cell.type === 'today') && this.cellMatchesDate(cell,
            this.value)) {
